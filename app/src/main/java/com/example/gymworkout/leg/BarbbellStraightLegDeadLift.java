...
public class BarbbellStraightLegDeadLift extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_barbbell_straight_leg_dead_lift);
        VideoView videoView=findViewById(R.id.nosepin);
